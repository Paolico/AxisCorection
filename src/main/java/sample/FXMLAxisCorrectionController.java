...
public class FXMLAxisCorrectionController implements Initializable {
    ...
    private FXMLMainScreenController consumer;
    ...
    public void setArgs2(RtlFileWrap rtlFileWrap, MeanMeasurementValue meanMeasurementValue, FXMLMainScreenController ctr) {
        rtlWrap = rtlFileWrap;
